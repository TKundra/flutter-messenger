...
/// participants are user ids
/// participantsName (chat participants) a map { userId: userDisplayName }
/// lastReadTime (last message read by whom & the time) a map ( userId: Timestamp }
class ChatRoomModel {
  final String id;
